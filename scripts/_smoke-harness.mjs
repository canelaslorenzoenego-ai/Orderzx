/**
 * Shared helpers for the dev-*-smoke.mjs suites. Copied verbatim from
 * dsh-android, which copied the convention from dsh-ios: every smoke is a plain
 * Node ESM script with no test framework, importing the COMPILED lib/*.js.
 *
